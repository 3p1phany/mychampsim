...
with open('trigger_addr.json') as f :
    js_data = js.load(f)
...
save_path = '../pdf/6.eval.metadata_storage_ratio.pdf'
...
def cal_data(data, test) :
    return data/js_data['cmc'][test]
...
for test in tests_list:
    ...
    ydata_item = []
    for method in ycat:
        ydata_item.append(cal_data(js_data[method][test], test))
