...
type_list = ["no", "stride", "stride-l1", "dbp", "cdp", "ipcp", "berti", "imp", 
             "gretch", "tyche", "domino", "isb", "misb", "triage-l1", "triangel", "cmc", 
             "domino-l2", "cmc-domino", "isb-l2", "cmc-isb", "misb-l2", "cmc-misb", 
             "triage-l2", "cmc-triage", "triangel-l2", "cmc-triangel"]

if(type not in type_list):
    print("Please enter correct type")
    exit(0)

config_fname = "champsim_config_4c.json"
...
elif(type=="stride" or type=="stride-l1" or type == "triage-l2" or type == "triangel-l2" or type=="misb-l2" or type=="isb-l2" or type=="domino-l2"):
...
if(type=="cmc" or type=="isb-l1" or type=="misb-l1" or type=="triage-l1" or type=="triangel" or type=="cmc-isb" or type=="cmc-misb" or type=="cmc-triage" or type=="cmc-triangel" or type=="cmc-domino"):
...
elif(type == "no" or type == "stride-l1" or type == "berti" or type == "dbp" or type == "cdp" or type == "domino" or type == "isb" or type == "misb" or type == "cmc" or type == "triage-l1" or type == "triangel"):
    command = f"sed -i '{config_line},{config_line}c\        \"prefetcher\": \"no\",' {config_fname}"
...
if(type=="isb-l2" or type=="cmc-isb" or type=="misb-l2" or type=="cmc-misb" or type=="triage-l2" or type=="cmc-triage" or type=="triangel-l2" or type=="cmc-triangel" or type=="domino-l2" or type=="cmc-domino"):
