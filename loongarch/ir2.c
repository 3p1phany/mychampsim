...
const LISA_REG_ACCESS_FORMAT lisa_reg_access_table[] = {
    ...
    {LISA_VLD, {FPR_WRITE, GPR_READ, IMM_SI12}, true}, // LISA_VLD {FPR_VD, GPR_RJ, IMM_SI12}
    {LISA_VST, {FPR_READ, GPR_READ, IMM_SI12}, true}, // LISA_VST {FPR_VD, GPR_RJ, IMM_SI12}
    {LISA_XVLD, {FPR_WRITE, GPR_READ, IMM_SI12}, true}, // LISA_XVLD {FPR_XD, GPR_RJ, IMM_SI12}
    {LISA_XVST, {FPR_READ, GPR_READ, IMM_SI12}, true}, // LISA_XVST {FPR_XD, GPR_RJ, IMM_SI12}
    ...
    {LISA_XVREPLGR2VR_B, {FPR_WRITE, GPR_READ}, true}, // LISA_XVREPLGR2VR_B {FPR_XD, GPR_RJ}
